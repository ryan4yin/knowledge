...
| 设备名称                            | 空载功耗 | 平时功耗 | 满载功耗 | 电源最大功率 | 每月用电量 |
| :---:                              | :---:  | :---:   | :---:   | :---:      | :---: |
...
这样算的话 GTR5 真的不适合当作常驻的机器用，电费太贵了，homelab 的主力机必须是低压的，15W 才是。
...
| Asgard SSD - AN3.0 512G NVMe-M.2/80 (TLC, 长江存储)  | 2022-11-02 | 京东自营    | ￥249 | UM560 的存储，2023-02-03 跪了，正在走售后 |
