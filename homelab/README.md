...
- 用旧手机当 Linux ARM 服务器，有两个方案：
  ...
  - 方案二：直接裸机安装 Linux 系统，主要是 postmarketOS，可以从 [Devices - postmarketOS](https://wiki.postmarketos.org/wiki/Devices) 找兼容性比较好的机器，性价比最高的貌似是就是一加 6T，骁龙 845 比我手上几个国产派的 RK3588s 弱一点点，但买个有瑕疵的价格大概只要 350。优势是性能好外设多（屏幕之类的外设用处可能也不大...），缺点就是得有时间折腾...没 AidLux 那么开箱即用。
