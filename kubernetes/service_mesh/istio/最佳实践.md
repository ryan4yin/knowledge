...
方法二：使用 EnvoyFilter: [./envoyfilters/enable-accesslog.yaml](./envoyfilters/enable-accesslog.yaml)
...
方法一，是使用 EnvoyFilter，如下是一个直接在 IngressGateway 上面返回 200 的例子：[./envoyfilters/direct_response.yaml](./envoyfilters/direct_response.yaml)
